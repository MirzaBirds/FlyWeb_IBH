...
import 'package:flyweb/src/helpers/dialog_utils.dart';
...
class _HomeScreen extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Permission.location.isGranted.then((value) {
      if (!value) {
        print("Called from On Board");
        DialogUtils.generic(context, onPositive: () async {
          await Permission.location.request();
        },onNegative: (){Navigator.of(context).pop(false);},settings: widget.settings );
